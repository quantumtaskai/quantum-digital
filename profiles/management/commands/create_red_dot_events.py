        ...
        try:
            with transaction.atomic():
                ...
                platform_data = [
                    ...
                    ('tiktok', 10, 1, 0, 'Short-form event highlights and behind-the-scenes', True),
                    ('instagram', 180, 45, 0, 'Visual event content, stories, and reels', True),
                    ('pinterest', 180, 0, 1, 'Event inspiration boards and planning content', True),
                    ('twitter', 180, 10, 1, 'Real-time event updates and engagement', True),
                    ('facebook', 180, 10, 0, 'Community building and event promotion', True),
                    ('medium', 30, 0, 2, 'Long-form thought leadership articles', True),
                    ('threads', 30, 0, 0, 'Text-based social engagement', True),
                    ('tumblr', 30, 10, 1, 'Creative visual content and storytelling', True),
                    
                    # Hidden platforms - not relevant for Red Dot Events
                    ('quora', 0, 0, 0, 'Q&A engagement', False),
                    ('reddit', 0, 0, 0, 'Community discussions', False),
                    ('bluesky', 0, 0, 0, 'Alternative social platform', False),
